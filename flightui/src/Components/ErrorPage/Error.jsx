  ...
  return (
    <>
      <body>
        ...
        <div class="text">
          <h1 className='heading-1'>404 Error</h1>
          <h2 className='heading-2'>{location.state.name}</h2>
          <h3 className='heading-3'>Page Not Found - lets take you <a  className="error-link" href={location.state.linkie}>BACK</a></h3>
        </div>
        </div>
      </body>
